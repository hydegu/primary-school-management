...
- 密码将使用BCrypt算法加密后存储
- 用户名、手机号、邮箱必须唯一
- 添加教师或学生时，建议同时创建对应的edu_teacher或edu_student记录
...
2. [ ] Service层详情查询方法
3. [ ] 关联查询用户角色
4. [ ] 根据用户类型关联查询对应信息（教师/学生/家长）

**注意事项**:
- 不返回密码字段
- 关联查询用户的角色信息
- 可以考虑根据userType关联查询edu_teacher或edu_student表的详细信息
