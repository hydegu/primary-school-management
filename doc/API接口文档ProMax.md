...
**实现位置**: `SubjectController.java:28`
...
```json
    {
      "subjectName": "思想品德",  //科目Id
      "subjectCode": "Moral character",  //科目编码
      "sortOrder": 11, //序号
      "status": 1,  //0 停用 1 启用
      "remark": "", //简介
      "avatar": "",  //封面
...
**实现位置**: `SubjectController.java:39`
...
**实现位置**: `SubjectController.java:43`
