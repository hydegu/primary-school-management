...
**实现位置**: `TeacherController.java:30`
...
**实现位置**: `TeacherController.java:44`
...
**功能描述**: 添加教师，自动创建用户账号（用户名：teacher+教师编号，默认密码：teacher123），并根据职称分配角色（班主任→角色ID=4，其他→角色ID=3）

**请求参数**:
```json
{
  "teacherNo": "T100",                           // 教师编号（必填）
  "teacherName": "李老师",                       // 教师姓名（必填）
  "gender": 1,                                   // 性别：1-男 2-女（必填）
  "birthDate": "1985-03-15",                     // 出生日期
  "idCard": "110101198503150011",                // 身份证号
  "phone": "13900139000",                        // 联系电话
  "email": "teacher100@school.com",              // 邮箱
...
**实现位置**: `TeacherController.java:54`
...
**功能描述**: 修改教师信息，同步更新用户信息和角色（职称变更时自动调整角色：班主任→角色ID=4，其他→角色ID=3）
...
```json
{
  ...
  "phone": "13900139000",                        // 联系电话
  "email": "teacher100@school.com",              // 邮箱
  "title": "班主任",                             // 职称（如：班主任/语文老师）
  "hireDate": "2024-09-01",                      // 入职日期
  "subjectIds": [1, 2, 3],                       // 教授的科目ID列表（可选，传null则不修改）
  "classIds": [1]                                // 班级ID列表（如果是班主任，可选）
}
```
...
```json
{
  ...
  "dataset": {
    ...
    "hireDate": "2024-09-01",                    // 入职日期
    "createdAt": "2025-11-20T10:00:00",         // 创建时间
    "updatedAt": "2025-11-22T15:30:00",         // 更新时间
    "subjectIds": [1, 2, 3],                     // 教授的科目ID列表
    "classIds": [1]                              // 班级ID列表
  }
}
```

**实现位置**: `TeacherController.java:64`
...
**功能描述**: 软删除教师，级联删除关联的用户账号、角色关联和科目关联
...
**实现位置**: `TeacherController.java:75`
...
**实现位置**: `TeacherController.java:84`

---

#### 为教师添加科目 ✅

**接口地址**: `POST /api/teacher/{teacherId}/subjects`
...
**实现位置**: `TeacherController.java:94`

---

#### 移除教师的科目 ✅

**接口地址**: `DELETE /api/teacher/{teacherId}/subjects`
...
**实现位置**: `TeacherController.java:104`
